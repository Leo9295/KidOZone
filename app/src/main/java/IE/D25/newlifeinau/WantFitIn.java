...
public class WantFitIn extends AppCompatActivity {

    ViewPager viewPager;
    slideAdapter6 adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.want_to_fit);
        viewPager = findViewById(R.id.viewPager);
        adapter = new slideAdapter6(this);
        ...
        timer.scheduleAtFixedRate(new WantFitIn.MyTimerTask(), 6000, 6000);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WantFitIn.this, Story.class);
    ...
    private void showDialog() {
        ...
        builder.setPositiveButton("True",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast toast = Toast.makeText(WantFitIn.this, "Great!", Toast.LENGTH_LONG);
                        toast.setGravity(Gravity.TOP, 0, 5 * (height / 8));
                        toast.show();
                        MediaPlayer mp = MediaPlayer.create(WantFitIn.this, R.raw.great);
                        mp.start();
                    }
                });
        builder.setNeutralButton("False", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Display display = getWindowManager().getDefaultDisplay();
                int height = display.getHeight();
                Toast toast = Toast.makeText(WantFitIn.this, "You can do it", Toast.LENGTH_LONG);
                toast.setGravity(Gravity.TOP, 0, 5 * (height / 8));
                toast.show();
                MediaPlayer mp = MediaPlayer.create(WantFitIn.this, R.raw.tryagain);
                mp.start();
            }
        });
    ...
    private class MyTimerTask extends TimerTask {
        @Override
        public void run() {
            WantFitIn.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
